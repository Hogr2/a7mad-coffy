...
export const products: Product[] = [
  {
    ...
    weight: "٢٥٠ غ",
    image: beans,
    story: "من مرتفعات كوتشيري، حبّة رقيقة تفتح على رائحة الياسمين ثم تهدأ في نفسٍ من بيرغموت. نُحمّصها فاتحةً لنُبقي الضوء داخلها.",
  },
  {
    id: "sidra",
    name: "سِدرة",
    ...
    weight: "٢٥٠ غ",
    image: bag,
    story: "تخمير لاهوائي بطيء يعيد رسم الحلاوة. الفراولة أولاً، ثم يهبط الكاكاو كخلفيةٍ دافئة.",
  },
  {
    id: "geisha",
    name: "غيشا",
    ...
    weight: "١٥٠ غ",
    image: cherry,
    story: "غيشا لا تحتاج تعريفاً. جرعة صغيرة تكفي لتُذكّرك لماذا نصحو مبكراً.",
  },
  {
    id: "harrar",
    name: "هرر",
    ...
    weight: "٢٥٠ غ",
    image: pour,
    story: "قهوةٌ لها ذاكرة. توتٌ داكن يذوب في نبيذٍ خفيف، وينتهي بكاكاو يبقى على اللسان.",
  },
  {
    id: "house",
    name: "خلطة البيت",
    ...
    weight: "٢٥٠ غ",
    image: bag,
    story: "خلطتنا اليومية. كثيفة كحليبٍ ساخن، مؤنسة كأصدقاء قدماء.",
  },
  {
    id: "decaf",
    ...
    weight: "٢٥٠ غ",
    image: beans,
    story: "لأولئك الذين يريدون الطقس دون الحماس. حلاوة تمر ولوز بلا سهرٍ طويل.",
  },
];
...
export const menu = {
  espresso: [
    { name: "إسبريسو", ar: "جرعة مركّزة", price: 3 },
  ...
  brew: [
    ...
    { name: "أيروبريس", ar: "مركّز نظيف", price: 7 },
