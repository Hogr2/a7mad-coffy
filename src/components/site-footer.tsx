      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-10 py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-display text-xl">الضّوء · محمصة قهوة مختصة</div>
          ...
          <p className="mt-6 text-sm text-muted-foreground max-w-sm leading-relaxed">
            نُحمّص القهوة بضوءٍ خفيف ونُقدّمها ببخارٍ صادق. من المزرعة إلى فنجانك، بلا اختصار.
          </p>
        </div>

        <div>
          <div className="font-mono text-[10px] uppercase tracking-[0.25em] text-brass mb-4">التنقّل</div>
        ...
        <div>
          <div className="font-mono text-[10px] uppercase tracking-[0.25em] text-brass mb-4">زُرنا</div>
